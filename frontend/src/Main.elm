...
todoDecoder =
  Decode.succeed Todo
    ...
    |> Pipeline.required "createdAt" (Decode.maybe Decode.string)
    |> Pipeline.required "updatedAt" (Decode.maybe Decode.string)
...
update msg model =
  case msg of
    ...
    TodoDone todo ->
      ( { model | requestStatus = Loading }, postTodo model.baseUrl { todo | completed = not todo.completed } )
